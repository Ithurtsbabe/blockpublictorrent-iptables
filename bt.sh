...
wget -q -O/etc/trackers https://raw.githubusercontent.com/Ithurtsbabe/blockpublictorrent-iptables/main/trackers
...
curl -s -LO https://raw.githubusercontent.com/Ithurtsbabe/blockpublictorrent-iptables/main/hostsTrackers
